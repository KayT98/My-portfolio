  ...
  return (
    ...
    <div id="top">
      ...
      and I look forward to making a positive impact in the field.
          ...
          <div className={styles.project}> 
            <ul>
              <li className={styles.li}><Link target="_blank" href='https://kayt98.github.io/API-Fetch/'>Pet Pics API Fetch - React & CSS3 <FontAwesomeIcon icon={faLink} /></Link></li>
              ...
              <li className={styles.li}><Link target="_blank" href='https://github.com/KayT98/musicPlayer'>Music Player - C# <FontAwesomeIcon icon={faLink} /></Link></li> 
              <img src={'../mp3.png'} className={styles.img} alt='clock' width={300} height={200}></img> 
            </ul>  
          </div>
